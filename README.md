...
| :-----------: | :------------------------------------------------------------: | :-------------------------------------------------: | ------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------: |
|      01       |                台灣疫苗接種小黃卡影像辨識 - 使用雲端AI服務為例                |      [Introduction](aigo-open/form-recognizer-tw-yellow-card/README.md)       | Taiwan COVID-19 Vax Card Image Recognition - Using Azure Form Recognizer                                                                                |                                             [Lesson](aigo-open/form-recognizer-tw-yellow-card/README.md)                                             |                       Muhammad                       |
