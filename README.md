# main[![GitHub license](https://img.shields.io/github/license/microsoft/ML-For-Beginners.svg)](https://github.com/microsoft/ML-For-Beginners/blob/master/LICENSE)
...
2.[利用影像辨識輔助木瓜成熟度判斷]([https://github.com/jack155861/papaya_image_classification/README.md](https://github.com/aigo-open/papaya_image_classification/blob/main/README.md)
...
| :-----------: | :------------------------------------------------------------: | :-------------------------------------------------: | ------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------: |
|      01       |                台灣疫苗接種小黃卡影像辨識 - 使用雲端AI服務為例                |      [Introduction](aigo-open/form-recognizer-tw-yellow-card/blob/master/README.md)       | Taiwan COVID-19 Vax Card Image Recognition - Using Azure Form Recognizer                                                                                |                                             [Lesson](aigo-open/form-recognizer-tw-yellow-card/README.md)                                             |                       Ryan                       |
